...
export type InputIconWrapperProps = Omit<
...
export const InputIconWrapper = React.forwardRef<
  React.ElementRef<"div">,
  InputIconWrapperProps
>(function InputIconWrapperComponent(
    ...
    >
      {onClick ? (
        <button
          ...
          className="p-1 rounded-md hover:bg-[hsl(0,0%,16%)]"
        >
          {children}
        </button>
      ) : (
...
export const InputExample = React.forwardRef<
